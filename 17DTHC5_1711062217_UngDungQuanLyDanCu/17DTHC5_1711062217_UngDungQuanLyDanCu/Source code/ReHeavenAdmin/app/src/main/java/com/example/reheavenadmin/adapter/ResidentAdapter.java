package com.example.reheavenadmin.adapter;
...
import com.example.reheavenadmin.callback.RecyclerClickListener;
        ...
        holder.setClickListener((view, pos) -> {
            ...
            holder.btn_delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    residentRef.child(Common.ResidentClick.getBlock()).child(Common.ResidentClick.getApartment()).removeValue();
